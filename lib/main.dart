...
import 'package:pdf_example/flutter_pdf_viewer.dart';
...
void main() {
 ...
 // runApp(MyAppPDF());
  //runApp(PdfExample());
  //runApp(MyAppBG1());
  // runApp(MyAppFlutterPDFViewer());
  // runApp(CachedPDFViewer());
  //runApp(MyAppBG1());
  runApp(PdfExample());
}
          ...
          body:Column(
            children: [
              ElevatedButton(onPressed: (){
                //Navigator.push(context, MaterialPageRoute(builder: (context)=>PDFScreen(path: '',byteArr: null,)));
        }, child: Text('Page 1')),
              PinchPage(),
            ],
          )
...
class _PinchPageState extends State<PinchPage> {
              ...
              switch (_showing) {
                ...
                case DocShown.tutorial:
                  _pdfControllerPinch.loadDocument(
                      pdfrx.PdfDocument.openAsset('assets/flutter_tutorial.pdf'));
                  _showing = DocShown.hello;
                  break;
                case DocShown.hello:
                  _pdfControllerPinch
                      .loadDocument(pdfrx.PdfDocument.openAsset('assets/hello.pdf'));
                ...
                case DocShown.password:
                  _pdfControllerPinch.loadDocument(pdfrx.PdfDocument.openAsset(
                    'assets/password.pdf',
                    password: 'MyPassword',
                  ));
  ...
  void getPdfBytes() async {
    ...
    _pdfControllerPinch = PdfControllerPinch(
      document: pdfx.PdfDocument.openData(_documentBytes),
      initialPage: _initialPage,
    );
    setState(() {});
  }
...
//   // void _zoomIn() {
//   //
//   //   print('_zoomLevel in :==> ${_zoomLevel.toString()}');
//   //   setState(() {
//   //     _zoomLevel += 0.3;
//   //   });
//   // }
//   //
//   // void _zoomOut() {
//   //   print('_zoomLevel out :==> ${_zoomLevel.toString()}');
//   //   setState(() {
//   //     _zoomLevel = _zoomLevel > 0.1 ? _zoomLevel - 0.3 : 0.1;
//   //   });
//   // }
//
//   void _zoomIn() {
